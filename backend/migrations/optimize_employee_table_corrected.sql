...
-- Step 2: Create backup of current employees table (lowercase)
...
-- Drop any other foreign keys that might reference employees table
...
-- Step 10: Update users table role enum (if it exists)
-- ALTER TABLE users MODIFY COLUMN role ENUM('admin', 'employee', 'user') NOT NULL;

-- Step 11: Add additional indexes
